...
class TestReachability extends StatefulWidget {
  static const routeName = '/test/Reachability';

  const TestReachability({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestReachabilityState();
  }
}

class _TestReachabilityState extends State<TestReachability> {
  ...
  SkyveTabPane(children: [
      ...
      SkyveVBox(children: [
        SkyveBorder(children: [
          SkyveForm(children: [
            ...
            BootstrapRow(decoration: BoxDecoration(border: Border.all(color: Colors.transparent, width: 10.0)), children: [
              BootstrapCol(sizes: 'col-12 col-md-4', invisibleForSizes: 'xs sm', child: const SkyveLabel('Non Persistent Aggregated Association')),
              BootstrapCol(sizes: 'col-12 col-md-8', child: 
                Text('LookupDescription ${_bean["nonPersistentAggregatedAssociation"]}'),
              ),
            ]),
            BootstrapRow(decoration: BoxDecoration(border: Border.all(color: Colors.transparent, width: 10.0)), children: [
              BootstrapCol(sizes: 'col-12 col-md-4', invisibleForSizes: 'xs sm', child: const SkyveLabel('Persistent Aggregated Association')),
              BootstrapCol(sizes: 'col-12 col-md-8', child: 
                Text('LookupDescription ${_bean["persistentAggregatedAssociation"]}'),
              ),
            ]),
            BootstrapRow(decoration: BoxDecoration(border: Border.all(color: Colors.transparent, width: 10.0)), children: [
              BootstrapCol(sizes: 'col-12 col-md-4', invisibleForSizes: 'xs sm', child: const SkyveLabel('Non Persistent Composed Association')),
              BootstrapCol(sizes: 'col-12 col-md-8', child: 
                Text('LookupDescription ${_bean["nonPersistentComposedAssociation"]}'),
              ),
            ]),
            BootstrapRow(decoration: BoxDecoration(border: Border.all(color: Colors.transparent, width: 10.0)), children: [
              BootstrapCol(sizes: 'col-12 col-md-4', invisibleForSizes: 'xs sm', child: const SkyveLabel('Persistent Composed Association')),
              BootstrapCol(sizes: 'col-12 col-md-8', child: 
                Text('LookupDescription ${_bean["persistentComposedAssociation"]}'),
              ),
            ]),
          ]),
        ]),
    ...
    SkyveTab(title: 'Non Persistent Aggregated Collection', children: [
      SkyveVBox(children: [
        SkyveDataGrid(rows: _bean['nonPersistentAggregatedCollection'], children: [
        ]),
      ]),
    ]),
    SkyveTab(title: 'Persistent Aggregated Collection', children: [
      SkyveVBox(children: [
        SkyveDataGrid(rows: _bean['persistentAggregatedCollection'], children: [
        ]),
      ]),
    ]),
    SkyveTab(title: 'Non Persistent Composed Collection', children: [
      SkyveVBox(children: [
        SkyveDataGrid(rows: _bean['nonPersistentComposedCollection'], children: [
        ]),
      ]),
    ]),
    SkyveTab(title: 'Persistent Composed Collection', children: [
      SkyveVBox(children: [
        SkyveDataGrid(rows: _bean['persistentComposedCollection'], children: [
        ]),
      ]),
    ]),
  ]),
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'Reachability', bizId);
      setState(() {
        _bean = bean;
      });
    }
