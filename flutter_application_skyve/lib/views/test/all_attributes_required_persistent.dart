...
class TestAllAttributesRequiredPersistent extends StatefulWidget {
  static const routeName = '/test/AllAttributesRequiredPersistent';

  const TestAllAttributesRequiredPersistent({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestAllAttributesRequiredPersistentState();
  }
}

class _TestAllAttributesRequiredPersistentState extends State<TestAllAttributesRequiredPersistent> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestAllAttributesRequiredPersistent.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'AllAttributesRequiredPersistent', bizId);
      setState(() {
        _bean = bean;
      });
    }
