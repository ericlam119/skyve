...
class TestMappedExtensionSingleStrategy extends StatefulWidget {
  static const routeName = '/test/MappedExtensionSingleStrategy';

  const TestMappedExtensionSingleStrategy({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestMappedExtensionSingleStrategyState();
  }
}

class _TestMappedExtensionSingleStrategyState extends State<TestMappedExtensionSingleStrategy> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestMappedExtensionSingleStrategy.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'MappedExtensionSingleStrategy', bizId);
      setState(() {
        _bean = bean;
      });
    }
