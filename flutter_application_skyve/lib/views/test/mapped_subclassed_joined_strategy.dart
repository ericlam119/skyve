...
class TestMappedSubclassedJoinedStrategy extends StatefulWidget {
  static const routeName = '/test/MappedSubclassedJoinedStrategy';

  const TestMappedSubclassedJoinedStrategy({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestMappedSubclassedJoinedStrategyState();
  }
}

class _TestMappedSubclassedJoinedStrategyState extends State<TestMappedSubclassedJoinedStrategy> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestMappedSubclassedJoinedStrategy.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'MappedSubclassedJoinedStrategy', bizId);
      setState(() {
        _bean = bean;
      });
    }
