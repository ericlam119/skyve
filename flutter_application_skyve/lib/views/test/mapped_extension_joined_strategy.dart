...
class TestMappedExtensionJoinedStrategy extends StatefulWidget {
  static const routeName = '/test/MappedExtensionJoinedStrategy';

  const TestMappedExtensionJoinedStrategy({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestMappedExtensionJoinedStrategyState();
  }
}

class _TestMappedExtensionJoinedStrategyState extends State<TestMappedExtensionJoinedStrategy> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestMappedExtensionJoinedStrategy.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'MappedExtensionJoinedStrategy', bizId);
      setState(() {
        _bean = bean;
      });
    }
