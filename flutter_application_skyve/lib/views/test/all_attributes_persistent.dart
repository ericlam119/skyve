...
class TestAllAttributesPersistent extends StatefulWidget {
  static const routeName = '/test/AllAttributesPersistent';

  const TestAllAttributesPersistent({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestAllAttributesPersistentState();
  }
}

class _TestAllAttributesPersistentState extends State<TestAllAttributesPersistent> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestAllAttributesPersistent.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'AllAttributesPersistent', bizId);
      setState(() {
        _bean = bean;
      });
    }
