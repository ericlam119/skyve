...
class TestAllAttributesDynamicEmbedded extends StatefulWidget {
  static const routeName = '/test/AllAttributesDynamicEmbedded';

  const TestAllAttributesDynamicEmbedded({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestAllAttributesDynamicEmbeddedState();
  }
}

class _TestAllAttributesDynamicEmbeddedState extends State<TestAllAttributesDynamicEmbedded> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestAllAttributesDynamicEmbedded.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'AllAttributesDynamicEmbedded', bizId);
      setState(() {
        _bean = bean;
      });
    }
