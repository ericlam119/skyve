...
class TestAllAttributesEmbedded extends StatefulWidget {
  static const routeName = '/test/AllAttributesEmbedded';

  const TestAllAttributesEmbedded({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TestAllAttributesEmbeddedState();
  }
}

class _TestAllAttributesEmbeddedState extends State<TestAllAttributesEmbedded> {
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        TestAllAttributesEmbedded.routeName,
        _bean['_title'],
        Visibility(
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('test', 'AllAttributesEmbedded', bizId);
      setState(() {
        _bean = bean;
      });
    }
