...
class KitchensinkLookupDescription extends StatefulWidget {
  static const routeName = '/kitchensink/LookupDescription';

  const KitchensinkLookupDescription({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _KitchensinkLookupDescriptionState();
  }
}

class _KitchensinkLookupDescriptionState extends State<KitchensinkLookupDescription> {
  ...
  void _load(String? bizId) async {
    if (_bean['bizId'] == null) {
      final bean = await SkyveRestClient().edit('kitchensink', 'LookupDescription', bizId);
      setState(() {
        _bean = bean;
      });
    }
