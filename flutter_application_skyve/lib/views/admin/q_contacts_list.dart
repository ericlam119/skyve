...
class AdminqContactsList extends StatefulWidget {
  static const routeName = '/admin/qContactsList';

  const AdminqContactsList({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AdminqContactsListState();
  }
}

class _AdminqContactsListState extends State<AdminqContactsList> {
  bool _loaded = false;
  List<dynamic> _rows = [];
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, AdminContact.routeName);
                    }),
              )
            ])));
  }
