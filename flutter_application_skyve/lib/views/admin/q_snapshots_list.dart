...
class AdminqSnapshotsList extends StatefulWidget {
  static const routeName = '/admin/qSnapshotsList';

  const AdminqSnapshotsList({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AdminqSnapshotsListState();
  }
}

class _AdminqSnapshotsListState extends State<AdminqSnapshotsList> {
  bool _loaded = false;
  List<dynamic> _rows = [];
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, AdminSnapshot.routeName);
                    }),
              )
            ])));
  }
  ...
  void _load() async {
    final rows = await SkyveRestClient().query('admin', 'qSnapshots', 0, 75);
    setState(() {
      _rows = rows;
      _loaded = true;
    });
