...
class AdminqTagsList extends StatefulWidget {
  static const routeName = '/admin/qTagsList';

  const AdminqTagsList({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AdminqTagsListState();
  }
}

class _AdminqTagsListState extends State<AdminqTagsList> {
  bool _loaded = false;
  List<dynamic> _rows = [];
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, AdminTag.routeName);
                    }),
              )
            ])));
  }
  ...
  void _load() async {
    final rows = await SkyveRestClient().query('admin', 'qTags', 0, 75);
    setState(() {
      _rows = rows;
      _loaded = true;
    });
