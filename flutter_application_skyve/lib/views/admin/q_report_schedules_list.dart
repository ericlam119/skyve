...
class AdminqReportSchedulesList extends StatefulWidget {
  static const routeName = '/admin/qReportSchedulesList';

  const AdminqReportSchedulesList({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AdminqReportSchedulesListState();
  }
}

class _AdminqReportSchedulesListState extends State<AdminqReportSchedulesList> {
  bool _loaded = false;
  List<dynamic> _rows = [];
  ...
  Widget build(BuildContext context) {
    ...
    return SkyveView.responsiveView(
        context,
        AdminqReportSchedulesList.routeName,
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, AdminReportTemplate.routeName);
                    }),
              )
            ])));
  }
  ...
  void _load() async {
    final rows = await SkyveRestClient().query('admin', 'qReportSchedules', 0, 75);
    setState(() {
      _rows = rows;
      _loaded = true;
    });
