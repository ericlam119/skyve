...
class AdminDataGroupList extends StatefulWidget {
  static const routeName = '/admin/DataGroupList';

  const AdminDataGroupList({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AdminDataGroupListState();
  }
}

class _AdminDataGroupListState extends State<AdminDataGroupList> {
  bool _loaded = false;
  List<dynamic> _rows = [];
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, AdminDataGroup.routeName);
                    }),
              )
            ])));
  }
  ...
  void _load() async {
    final rows = await SkyveRestClient().query('admin', 'DataGroup', 0, 75);
    setState(() {
      _rows = rows;
      _loaded = true;
    });
